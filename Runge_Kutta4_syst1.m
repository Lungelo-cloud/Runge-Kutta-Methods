...
for i=1:N
    ...
    K2y1=fy1(t(i)+h/2,y1(i)+h/2*K1y1,y2(i)+h/2*K1y2);
    K2y2=fy2(t(i)+h/2,y1(i)+h/2*K1y1,y2(i)+h/2*K1y2);
    K3y1=fy1(t(i)+h/2,y1(i)+h/2*K2y1,y2(i)+h/2*K2y2);
    K3y2=fy2(t(i)+h/2,y1(i)+h/2*K2y1,y2(i)+h/2*K2y2);
    K4y1=fy1(t(i+1),y1(i)+h*K3y1,y2(i)+h*K3y2);
    K4y2=fy2(t(i+1),y1(i)+h*K3y1,y2(i)+h*K3y2);
...
hold on
plot(t,Fy1,'mo','linewidth',3)
%title('RK4 syst','fontsize',20)
