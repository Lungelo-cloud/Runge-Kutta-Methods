...
for i=1:N
   ...
   K2y1=fy1(t(i+1),y1(i)+h*K1y1,y2(i)+h*K1y2);
   K2y2=fy2(t(i+1),y1(i)+h*K1y1,y2(i)+h*K1y2);
   y1(i+1)=y1(i)+(h/2)*(K1y1+K2y1);
   y2(i+1)=y2(i)+(h/2)*(K1y2+K2y2);
end
Fy1=fexy1(t);
Fy2=fexy2(t);
errory1=abs(Fy1-y1);
